...
### 地图增强
- [ ] **[F]** 地图样式切换：标准/卫星/地形
- [ ] **[F]** 成员间距离显示：底部面板列出各成员距离
- [ ] **[F]** 成员方向指示：地图边缘箭头指示屏幕外成员方向

### 消息增强
- [ ] **[F]** 消息本地缓存：Hive 存储已加载消息，离线可查看
- [ ] **[F]** @ 成员功能：输入 @ 弹出成员选择列表
...
### 后台定位
- [ ] **[F]** 集成 flutter_background_service：后台继续上报位置
- [ ] **[F]** 电量优化：后台自动降低上报频率
...
### 后端安全
- [ ] **[B]** 接口限流：登录 5次/分钟，其他 60次/分钟
- [ ] **[B]** 输入校验：validator crate 严格校验所有请求参数
- [ ] **[B]** WebSocket 安全：握手强制验证 JWT，无效 token 立即关闭
- [ ] **[B]** 敏感数据：密码 argon2 hash，日志脱敏
